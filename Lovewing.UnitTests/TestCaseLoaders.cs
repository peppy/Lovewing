...
namespace Lovewing.UnitTests
{
    ...
    public class TestCaseLoaders
    {
        ...
        public async Task LLPLoaderTest()
        {
            ...
            Assert.AreEqual("tL0IRtvENu7GFWdP.wav", beatmap.MusicFile);
            ...
            Assert.AreEqual("G5rJhs4a1h4B2v7N.wav", beatmap.MusicFile);
            ...
            Assert.AreEqual("2o8bOtehEbonP11b.wav", beatmap.MusicFile);
